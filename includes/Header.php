...
<script type="text/babel">
  ...
  function Header() {
    ...
    useEffect(() => {
      const timeout = setTimeout(() => {
        ...
        if (el) {
          ...
          if (span) {
            let left = span.offsetLeft + el.offsetLeft - 12;
            let width = span.offsetWidth + 24;
    ...
    return (
      <nav className="bg-white shadow-md px-6 py-3 fixed top-0 left-0 right-0 z-50 overflow-x-hidden">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-6 relative">
            <div
              className="absolute rounded transition-all duration-500 ease-out max-w-full"
              style={{
            ...
            {dropdownOpen && (
              <div className="absolute right-0 mt-2 w-48 bg-white border rounded-lg shadow-lg py-2 z-50">
                ...
                <a href="#" className="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2122 2122" className="w-5 h-5 mr-2" fill="currentColor">
